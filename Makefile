...
PKG_VERSION:=0.2
PKG_RELEASE:=1
PKG_MAINTAINER:=James Klaas <jklaas@gmail.com>
PKG_LICENSE:=GPLv2
...
define Package/luci-app-radius
   SECTION:=luci
   CATEGORY:=LuCI
   DEPENDS:=+freeradius3-democerts +freeradius3-mod-eap-mschapv2 +freeradius3-mod-eap-peap +freeradius3-mod-eap-tls +freeradius3-mod-files +luci-compat
   TITLE:=Radius Server Management
   MAINTAINER:=James Klaas <jklaas@gmail.com>
   PKGARCH:=all
endef
